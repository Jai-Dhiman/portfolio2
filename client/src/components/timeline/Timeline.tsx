  ...
  const timelineItems = [
    {
      ...
      description: "Co-Founded a privacy-first social platform (50-user beta) and scaled from solo builder to a 3-person engineering team. Drove +40% engagement through systematic A/B testing and shipped a fast, safety-focused recommendation engine.",
      highlights: [
    ...
    },
    {
      ...
      description: "Completed full-stack software program, and self-studied CS fundamentals (algorithms, systems, design patterns). Built multiple production-ready applications applying distributed systems and data-structure concepts.",
      highlights: [
