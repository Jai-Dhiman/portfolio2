          ...
          >
            ...
            <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-start">
              ...
              <div className="space-y-12">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-6 text-gray-700 dark:text-gray-300">Technical Architecture & Design</h3>
                    ...
                    <div className="w-full">
                      ...
                      <Tilt tiltMaxAngleX={3} tiltMaxAngleY={3}>
                        <img 
                          ...
                          className="w-full h-auto rounded-xl shadow-2xl object-cover transform scale-110"
                        />
                      </Tilt>
                    </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-start">
              ...
              {/* Right: Demo Video */}
              <div>
                <h3 className="text-xl font-semibold mb-6 text-gray-700 dark:text-gray-300">Product Demo</h3>
                <div className="w-full h-auto">
                  <Tilt tiltMaxAngleX={5} tiltMaxAngleY={5}>
                    <div className="relative w-full rounded-xl overflow-hidden shadow-2xl" style={{ paddingBottom: '56.25%' }}>
                      <YouTubeEmbed 
                        videoId="dQw4w9WgXcQ" 
                        title="FridgeAI Demo - Coming Soon"
