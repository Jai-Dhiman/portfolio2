...
// ../.wrangler/tmp/bundle-6FBe9S/strip-cf-connecting-ip-header.js
  ...
  const experiences = [
    {
      ...
      description: "Built production recommendation engine (10K+ items) with semantic search; implemented safety evaluation (Recall@K/MRR/NDCG) and A/B testing; designed multi-layer safety systems and monitoring dashboards.",
    ...
    },
    {
      ...
      description: "Automated Python ML workflows and built monitoring dashboards (reduced manual interventions by ~25%); contributed to secure CI/CD deployment infrastructure.",
    ...
    },
    {
      ...
      description: "Full\u2011stack development with emphasis on data structures, algorithms, and distributed system design.",
...
// ../.wrangler/tmp/pages-Gn6oIq/functionsRoutes-0.9527310284910444.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-6FBe9S/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-6FBe9S/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.3192659704781351.mjs.map
