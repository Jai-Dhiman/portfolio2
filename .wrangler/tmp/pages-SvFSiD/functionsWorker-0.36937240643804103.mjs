...
// ../.wrangler/tmp/bundle-X4URbZ/strip-cf-connecting-ip-header.js
  ...
  const experiences = [
    {
      ...
      company: "Capture",
      description: "Led expansion from solo engineering team to 3 engineers, launching 50-user beta with systematic A/B testing achieving 40% engagement improvement; mentored 2 engineers on code review and Git workflow practices.",
    ...
    },
    {
      ...
      description: "Deployed production audio ML system: Rust preprocessing (Cloudflare Workers), Modal GPU inference (2-5s), SvelteKit web app with real-time recording achieving <100ms global edge response times.",
    ...
    },
    {
      ...
      description: "Implemented 4-stage Constitutional AI pipeline from Anthropic papers (JAX/Flax safety classifier, LoRA fine-tuning, 400-pair critique-revision, DPO training) achieving 23% improvement in harmful refusal.",
    ...
    },
    {
      ...
      description: "Full-stack development with algorithms, data structures, and system design.",
...
// ../.wrangler/tmp/pages-SvFSiD/functionsRoutes-0.4781210092328647.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-X4URbZ/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-X4URbZ/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.36937240643804103.mjs.map
